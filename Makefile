...
OBJECTS = o_files/main.o o_files/choose_color_and_name_byType.o o_files/wrPngFile.o o_files/readFile.o o_files/refactorToTokens.o o_files/predprocessing.o o_files/wrDotFile.o o_files/treeFuncs.o o_files/writeASMfile.o
...
o_files/choose_color_and_name_byType.o: source/graphDump/choose_color_and_name_byType.cpp
	g++ -c source/graphDump/choose_color_and_name_byType.cpp -o o_files/choose_color_and_name_byType.o $(DEBUG_SET)  $(DIFFERENT_FLAGS) $(SANITIZER)
...
o_files/treeFuncs.o: source/treeFuncs.cpp
	g++ -c source/treeFuncs.cpp -o o_files/treeFuncs.o $(DEBUG_SET)  $(DIFFERENT_FLAGS) $(SANITIZER)

o_files/writeASMfile.o: source/writeASMfile.cpp
	g++ -c source/writeASMfile.cpp -o o_files/writeASMfile.o $(DEBUG_SET)  $(DIFFERENT_FLAGS) $(SANITIZER)
