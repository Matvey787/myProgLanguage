...
OBJECTS = o_files/main.o o_files/readFile.o o_files/refactorToTokens.o o_files/predprocessing.o o_files/wrDotFile.o o_files/delTree.o o_files/writeASMfile.o
...
o_files/delTree.o: source/delTree.cpp
	g++ -c source/delTree.cpp -o o_files/delTree.o $(DEBUG_SET)  $(DIFFERENT_FLAGS) $(SANITIZER)
